const CONFIG = {
  ...
  ID_PREFIX: { CLIENT:'CLI', ENGAGEMENT:'ENG', PROJECT:'PRJ', DELIVERABLE:'DLV', CONTENT:'CNT', PAYMENT:'PAY', CLIENT_RECEIPT:'REC', EMPLOYEE_PAYMENT:'EMP', BUSINESS_EXPENSE:'EXP', ACTIVITY:'ACT' },
